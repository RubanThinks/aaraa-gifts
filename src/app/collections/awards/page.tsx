    ...
    return (
        <main className="bg-brand-ivory min-h-screen">
            ...
            <div className="pt-32 pb-20 container mx-auto px-6 text-center">
                <span className="text-[10px] uppercase tracking-[0.6em] text-brand-copper font-bold mb-6 block underline decoration-brand-copper/30 underline-offset-8">Excellence & Accolades</span>
                <h1 className="text-5xl md:text-8xl font-serif text-brand-espresso mb-8 leading-tight">Elite Award <br /> <span className="italic font-light text-brand-brown">Gifts.</span></h1>
                <p className="text-brand-espresso/50 text-xl max-w-2xl mx-auto font-light leading-relaxed italic">
                    "Prestigious monuments of achievement designed to immortalize success and celebrate extraordinary journeys."
                </p>
            </div>
