    ...
    return (
        <main className="bg-brand-ivory min-h-screen">
            ...
            <div className="pt-32 pb-20 container mx-auto px-6 text-center">
                <span className="text-[10px] uppercase tracking-[0.6em] text-brand-copper font-bold mb-6 block underline decoration-brand-copper/30 underline-offset-8">Corporate Visibility</span>
                <h1 className="text-5xl md:text-8xl font-serif text-brand-espresso mb-8 leading-tight">Promotional <br /> <span className="italic font-light text-brand-brown">Collections.</span></h1>
                <p className="text-brand-espresso/50 text-xl max-w-2xl mx-auto font-light leading-relaxed italic">
                    "High-impact branded merchandise designed to keep your institution in focus."
                </p>
            </div>

            <div className="container mx-auto px-6 pb-40">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16">
                    {promotionalProducts.map((product, i) => (
                        <motion.div
                            key={product.id}
